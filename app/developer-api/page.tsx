...
export const metadata: Metadata = {
  title: 'Developer API Documentation | DeSocial Plug',
  description: 'Learn how to programmatically access and purchase logs using the DeSocial Plug API.',
};
        ...
        <div className="max-w-5xl mx-auto px-6 py-16 md:py-24">
          <header className="mb-16 space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-foreground">
              DeSocial Plug <span className="text-blue-500">Developer API</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl">
              Powerful endpoints to integrate DeSocial Plug's inventory directly into your applications, panels, and tools.
            </p>
          </header>
