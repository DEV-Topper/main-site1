...
const AboutSection = () => {
  return (
    <section className="w-full bg-gray-50 py-14 md:py-24 px-4 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        
        {/* Left: Text */}
        <div className="w-full md:w-1/2 text-gray-800 text-center md:text-left flex flex-col justify-center items-center md:items-start">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-5 text-gray-900 leading-tight">
            About <span className="text-blue-600">De’socialPlug</span>
          </h2>
          <p className="text-base sm:text-lg leading-relaxed mb-4 text-gray-700 max-w-lg">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-gray-700 max-w-lg">
